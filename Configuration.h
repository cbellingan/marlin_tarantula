...
#define STRING_CONFIG_H_AUTHOR "Zviper89, Migbot Stndrdauto lvl,hastla" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "David's Tarantula"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
// #define MACHINE_UUID "0d4aecf0-544e-11e5-885d-feff819cdc9f"
...
// TEVO Tarantula Stock PID Settings - Hotend
...
// TEVO Tarantula Stock PID Settings - Heatbed
...
// TEVO Tarantula Custom PID Settings - Heatbed with borosilicate glass
    #define  DEFAULT_bedKp 63.77
    #define  DEFAULT_bedKi 12.55
    #define  DEFAULT_bedKd 80.97
...
// TEVO Tarantula Stock dangerous extrusion
//#define EXTRUDE_MINTEMP 170

// TEVO Tarantula Custom dangerous extrusion
#define EXTRUDE_MINTEMP 16
...
// For TEVO Tarantula Auto-Level uncomment the 2 following lines not proved yet
...
// TEVO Tarantula Stock Settings - Home position
...
// default settings
// TEVO Tarantula Stock Settings - E-steps
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,100}  // default steps per unit for Tarantula //78.7402, 78.7402,1070,865.88
// TEVO Tarantula Custom Settings - E-steps
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,97.0874}  // custom steps per unit for Tarantula
#define DEFAULT_MAX_FEEDRATE          {225, 225, 3, 25}    // (mm/sec)


// TEVO Tarantula Stock Settings - Acceleration
...
//#define DEFAULT_ACCELERATION          2650    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
// TEVO Tarantula Custom Settings - Acceleration
...
#define MEASURED_LOWER_LIMIT          1  //lower limit factor for sensor reading validation in mm
